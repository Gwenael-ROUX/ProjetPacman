...
public class YellowGhostBuilder extends EntityCharacterBuilder {
    @Override
    ...
    public void buildImageView() {
        entityCharacter.setImageView(new ImageView(new Image(LevelGenerator.class.getResourceAsStream("/Image/GhostYellow.png"))));
    }
    ...
    public void buildAnimation() {
        ...
        animations.get("up").add(new ImageView(new Image(LevelGenerator.class.getResourceAsStream("/Image/GhostYellow.png"))));

        animations.put("down", new ArrayList<ImageView>());
        animations.get("down").add(new ImageView(new Image(LevelGenerator.class.getResourceAsStream("/Image/GhostYellow.png"))));


        animations.put("right", new ArrayList<ImageView>());
        animations.get("right").add(new ImageView(new Image(LevelGenerator.class.getResourceAsStream("/Image/GhostYellow.png"))));

        animations.put("left", new ArrayList<ImageView>());
        animations.get("left").add(new ImageView(new Image(LevelGenerator.class.getResourceAsStream("/Image/GhostYellow.png"))));
